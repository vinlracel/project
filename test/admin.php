...
<body>
    ...
    function accept() {
        ...
        {
            document.getElementById("accept").setAttribute("href", ""); 
        }
    }
    function reject() {
        let text = "Press Okay to Confirm";
        if (confirm(text) != true)
        {
            document.getElementById("reject").setAttribute("href", ""); 
        }
    }
    </script>
    <div class="sidebar">
        ...
        <div class="content">
            ...
            <div class="table-container">
                ...
                while($row = $result->fetch_assoc())
                {
                    ...
                    <td>
                    <a class = 'accept' id = 'accept' onclick = 'accept()' href= 'accept.php?id=$row[id]&name=$row[name]&email=$row[email]&address=$row[address]&cnum=$row[cnum]&date=$row[date]&time=$row[time]&fee=$row[fee]&activities=$row[activities]&islands=$row[islands]'><strong>Accept</strong></a>
                    <a class = 'decline' id = 'reject' onclick = 'reject()' href= 'reject.php?id=$row[id]&name=$row[name]&email=$row[email]&address=$row[address]&cnum=$row[cnum]&date=$row[date]&time=$row[time]&fee=$row[fee]&activities=$row[activities]&islands=$row[islands]'><strong>Reject</strong></a>
                    </td>
                    </tr>";
                }
